# apps/user_authentication/models.py
...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    user_permissions = models.ManyToManyField('auth.Permission', related_name='custom_user_set', blank=True, help_text='Specific permissions for this user.')
